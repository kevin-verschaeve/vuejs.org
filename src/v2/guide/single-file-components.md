...
Dans le cas où vous prefereriez créer votre installation depuis le départ, vous pourrez configurer manuellement webpack avec [vue-loader](https://vue-loader.vuejs.org). Pour en apprendre plus à propos de webpack en lui même, consultez la [documentation officielle](https://webpack.js.org/configuration/) et la [Webpack Academy](https://webpack.academy/p/the-core-concepts).
